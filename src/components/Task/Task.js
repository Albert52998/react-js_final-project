  ...
  render() {
    ...
    return (
      <Card className={cardClasses.join(" ")}>
        ...
        <Card.Body>
          {disabled ? (
            <Card.Title className="h3">{data.title}</Card.Title>
          ) : (
          ...
          <Card.Text>Description: {shortStr(data.description, 60)}</Card.Text>
          ...
          {data.status === "active" ? (
            ...
            >
              <Button
                ...
                variant="success"
                onClick={() =>
                  this.props.changeTaskStatus(data._id, { status: "done" })
                }
                disabled={disabled}
              >
            ...
            >
              <Button
                ...
                variant="warning"
                onClick={() =>
                  this.props.changeTaskStatus(data._id, { status: "active" })
                }
                disabled={disabled}
              >
